...
- [x] Remove definitions footnote section from the report.
...
- 2026-02-25: Removed the definitions footnote block from report output per user request; full tests still pass (`18 passed`).
